...
//IN MAPSTATETOPROPS GET THE USER DATA FROM THE REDUX STORE ONTO THE PROPS OBJECT >> user: state.user
...
//the second argument for connect is an object that takes in all fo the action creators from the reducers and provides access to them in this.props.
